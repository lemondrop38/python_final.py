...
question3 = input("You see a door you try to open it and its locked, you remember you have a key and you open it. You close the door behind you and you see a bear coming at you, but the door is now stuck. Do you run or stay and fight the bear?(6 means run 7 means fight)") # sophia q
if question3 == 6:
...
question2 = input("You're outside and hear water.(4 means go twords the water 5 mmeans go in the oppisite direction)") #isabella german
...
if question2 == 4:
      ...
      if question2 == 8:
            ...
            print("They ask you if you need help, you say yes and they help you get back home")#isabella german
elif question2 == 5:
